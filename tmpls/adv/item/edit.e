...
<option {{if eq $item.size_id 18}}selected{{end}} value=18>Half Page Ad 300x600</option></select>
    ...
    <label for="inputEndx" class="col-sm-1 col-form-label">Mime:</label>
    <div class="col-sm-4">
...
<option {{if eq $item.qa_mime "mp4"}}selected{{end}} value="mp4">png</option>
...
<div class="form-group row">
    <div class="col-sm-9">
<button type="submit" class="btn btn-primary">Update Item Now!</button>
    </div>
</div>
