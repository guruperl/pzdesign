...
<div class="form-group row">
    <label for="inputCampaigName" class="col-sm-3 col-form-label">Item Name:</label>
    <div class="col-sm-9">
...
<div class="form-group row">
    <label for="inputLanding" class="col-sm-3 col-form-label">After Click:</label>
    <div class="col-sm-9">
...
<div class="form-group row">
    <label for="inputStartx" class="col-sm-3 col-form-label">Start:</label>
    <div class="col-sm-4">
        <input type=text class="form-control" name="startx" placeholder="yyyy-mm-dd hh:mm:ss" />
    </div>
	<div class="col-sm-1">
    <label for="inputEndx" class="col-sm-1 col-form-label">End:</label>
	</div>
    <div class="col-sm-4">
...
<div class="form-group row">
    <label for="inputCost" class="col-sm-3 col-form-label">Cost Type:</label>
    <div class="col-sm-4">
...
<input type=radio name=cost_type value=CPA>CPA
	...
	<div class="col-sm-1">
    <label for="inputEndx" class="col-sm-1 col-form-label">Price:</label>
	</div>
    <div class="col-sm-4">
...
<div class="form-group row">
    <label for="inputCost" class="col-sm-12 col-form-label">Should Appear In The Following Slots</label>
...
<input class="form-check-input" id="fl_{{$item.which}}" type=checkbox name=fl_platform value="{{$item.which}}" {{if $item.default}}checked{{end}} />{{$item.label}}{{end}}
    </div>
</div>
...
<input class="form-check-input" id="fl_{{$item.which}}" type=checkbox name=fl_clock value="{{$item.which}}" {{if $item.default}}checked{{end}} />{{$item.label}}{{end}}
    </div>
</div>
...
<input class="form-check-input" id="fl_{{$item.which}}" type=checkbox name=fl_yaxis value="{{$item.which}}" {{if $item.default}}checked{{end}} />{{$item.label}}{{end}}
    </div>
</div>
