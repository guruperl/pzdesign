...
<td><a class="btn btn-sm btn-danger" href="creative?action=delete&creative_id={{.creative_id}}&{{$attach}}&{{$second}}">删除</a></td>
</tr>{{end}}{{end}}
</table>
                            </div>
                            <!-- /.table-responsive -->
...
<div class="form-group row">
    <label for="inputContent" class="col-sm-3 col-form-label">物料地址 ({{index .ARGS.qa_mime 0}}):</label>
    <div class="col-sm-9">
