...
<body class="w8m-public-account theme-internal">
      ...
      <div class="account-card account-card-compact theme-internal">
        ...
        <section class="account-form-panel">
          ...
          <form method="post" action="/goto/admin/g/{{ .LoginName }}">
            ...
            <div class="account-field"><label for="admin-login-totp">身份验证器验证码或恢复代码</label><div class="account-control"><i class="fa fa-shield" aria-hidden="true"></i><input id="admin-login-totp" class="form-control" name="{{.TOTP}}" type="text" placeholder="已启用双重验证时填写" autocomplete="one-time-code"></div></div>
  ...
  <footer class="account-footer"><div class="container"><p>&copy; 2026 W8M 网络有限公司</p><nav aria-label="账户页脚导航"><a href="/privacy.zh.html">隐私政策</a> · <a href="/terms.zh.html">服务条款</a> · <a href="mailto:support@w8m.com">联系支持</a></nav></div></footer>
</body>
</html>
