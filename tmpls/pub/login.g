          ...
          <div class="card p-4">
            <div class="card-body">
              ...
              <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" name="{{ .Other.Login }}" placeholder="电子邮箱">
              </div>
              <div class="input-group mb-4">
                <div class="input-group-prepend">
                  <span class="input-group-text"><i class="icon-lock"></i></span>
                </div>
                <input type="password" class="form-control" NAME="{{ .Other.Password }}" placeholder="密码">
              </div>
              <div class="row">
                <div class="col-6">
